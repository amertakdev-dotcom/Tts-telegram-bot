...
// Same as buildInlineKeyboard but with extra rows for the photo-driven
// features (OCR + exercise solver), used only on the /start welcome message.
function buildStartKeyboard(user) {
  ...
  base.reply_markup.inline_keyboard.push([
    ...
    { text: "🧮 ដោះស្រាយលំហាត់", callback_data: "solve_start" },
  ]);
  return base;
}
